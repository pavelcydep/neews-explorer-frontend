...
const popupClose = document.querySelector('.popup__close-registration');
const popupSuccessfulRegistration = document.querySelector('.popup__close-successful-registration');
export {
  root,
  header,
  search,
  ...
  popupClose, popupSuccessfulRegistration,
